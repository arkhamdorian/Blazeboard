...
namespace keyboard_layout
{
    public partial class Form1 : Form
    {
        //Dll imports
        #region
        [DllImport(@"C:\\Users\\Sweet 
Home\\Documents\\DSA\\Keyboard\\Debug\\Keyboard_schema.dll", 
CallingConvention = CallingConvention.Cdecl)]
        public static extern void init();
        [DllImport(@"C:\\Users\\Sweet 
Home\\Documents\\DSA\\Keyboard\\Debug\\Keyboard_schema.dll", 
CallingConvention = CallingConvention.Cdecl)]
        public static extern void Search(string str, StringBuilder str1, 
StringBuilder str2, StringBuilder str3);
        [DllImport(@"C:\\Users\\Sweet 
Home\\Documents\\DSA\\Keyboard\\Debug\\Keyboard_schema.dll", 
CallingConvention = CallingConvention.Cdecl)]
        public static extern void Space(string str, StringBuilder str1, 
StringBuilder str2, StringBuilder str3,int choice);
        [DllImport(@"C:\\Users\\Sweet 
Home\\Documents\\DSA\\Keyboard\\Debug\\Keyboard_schema.dll", 
CallingConvention = CallingConvention.Cdecl)]
        ...
        private void Prediction_click(object sender,EventArgs e)
        {
            ...
            //string code = 
choosen_word.Substring(choosen_word.IndexOf(t) + choosen_word.Length);
            string rest_of_string = choosen_word.ToLower().Split(new 
string[] { t }, StringSplitOptions.None).Last();
