...
extern "C"
{
	...
	__declspec(dllexport) void Space(const 
char*prev,char*str1,char*str2,char*str3,int choice)
	{
		insert(head,prev,1);
		nextword(str1,str2,str3,choice);
	}
	__declspec(dllexport) void Search(const char *text, 
